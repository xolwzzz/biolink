...
async function initDb() {
  ...
  db.run(`CREATE TABLE IF NOT EXISTS profile (
    ...
    avatar_emoji TEXT DEFAULT 'STAR',
  ...
  const migrations = [
    ...
    "ALTER TABLE profile ADD COLUMN avatar_emoji TEXT DEFAULT 'STAR'",
    "ALTER TABLE profile ADD COLUMN avatar_type TEXT DEFAULT 'emoji'",
    "ALTER TABLE profile ADD COLUMN avatar_img_path TEXT",
    ...
    "ALTER TABLE profile ADD COLUMN seo_title TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN seo_description TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN theme TEXT DEFAULT 'dark'",
