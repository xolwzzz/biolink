...
async function initDb() {
  ...
  const migrations = [
    ...
    "ALTER TABLE profile ADD COLUMN tagline TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN bio_font TEXT DEFAULT 'Inter'",
    "ALTER TABLE profile ADD COLUMN subtext_color TEXT DEFAULT '#aaaaaa'",
    "ALTER TABLE profile ADD COLUMN tagline_size INTEGER DEFAULT 13",
    "ALTER TABLE profile ADD COLUMN spacing_gap INTEGER DEFAULT 10",
    "ALTER TABLE profile ADD COLUMN max_width INTEGER DEFAULT 360",
    "ALTER TABLE profile ADD COLUMN align TEXT DEFAULT 'center'",
    "ALTER TABLE profile ADD COLUMN position TEXT DEFAULT 'bottom'",
    "ALTER TABLE profile ADD COLUMN page_style TEXT DEFAULT 'minimal'",
    "ALTER TABLE profile ADD COLUMN bg_type TEXT DEFAULT 'solid'",
    "ALTER TABLE profile ADD COLUMN button_style TEXT DEFAULT 'filled'",
    "ALTER TABLE profile ADD COLUMN button_font_size INTEGER DEFAULT 14",
    "ALTER TABLE profile ADD COLUMN avatar_size INTEGER DEFAULT 72",
    "ALTER TABLE profile ADD COLUMN avatar_shape TEXT DEFAULT 'circle'",
    "ALTER TABLE profile ADD COLUMN social_twitter TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_instagram TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_tiktok TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_youtube TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_linkedin TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_github TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN social_spotify TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN page_title TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN meta_desc TEXT DEFAULT ''",
    "ALTER TABLE profile ADD COLUMN splash_style TEXT DEFAULT 'pulse'",
    "ALTER TABLE profile ADD COLUMN splash_color TEXT DEFAULT 'rgba(255,255,255,0.45)'",
  ];
