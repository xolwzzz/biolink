...
async function initDb() {
  ...
  try { db.run('ALTER TABLE profile ADD COLUMN video_muted INTEGER DEFAULT 0'); db.save(); } catch(e) {}
  try { db.run("ALTER TABLE profile ADD COLUMN enter_text TEXT DEFAULT 'click to enter'"); db.save(); } catch(e) {}
